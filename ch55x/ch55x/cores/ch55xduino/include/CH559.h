...
#define INT_NO_TKEY       7         // interrupt number for touch-key timer is not existing on the CH558 and CH559 but needs to be defined for simplicity
#define INT_NO_PWMX       11         // interrupt number for touch-key timer is not existing on the CH558 and CH559 but needs to be defined for simplicity
